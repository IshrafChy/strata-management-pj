      ...
      <div className="container mx-auto p-4">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside">
            <li><a href="/docs/meeting-minutes/january-2025" className="text-blue-500 hover:underline">January 2025</a></li>
            <li><a href="/docs/meeting-minutes/february-2025" className="text-blue-500 hover:underline">February 2025</a></li>
          </ul>
        </section>
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside">
            <li><a href="/docs/financial-reports/2024" className="text-blue-500 hover:underline">2024 Financial Report</a></li>
            <li><a href="/docs/financial-reports/2023" className="text-blue-500 hover:underline">2023 Financial Report</a></li>
          </ul>
        </section>
        <section>
